...
from core.OCKRA.metrics import InformationScore, InterquartileRange, PearsonCorrelation, IntraClassDistance
from core.OCKRA.methods import getMean, getMajority, getBorda
